...
myapp.ViewDeliveryAssessment.Comments_postRender = function (element, contentItem) {
    // Write code here.
    $(element).children().children("span").replaceWith(contentItem.value);
};
myapp.ViewDeliveryAssessment.BookingInReferenceNumber_postRender = function (element, contentItem) {
    $(element).children().children("span").text(contentItem.value.toUpperCase());
};
myapp.ViewDeliveryAssessment.ScreenContent_render = function (element, contentItem) {
